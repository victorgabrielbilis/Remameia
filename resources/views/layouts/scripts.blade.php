<!-- Javascript files-->
    ...
    <script src="{{URL::asset('vendor/owl.carousel2.thumbs/owl.carousel2.thumbs.min.js')}}"></script>
    ...
    <script src="{{URL::asset('vendor/jquery.scrollto/jquery.scrollTo.min.js')}}"></script>
