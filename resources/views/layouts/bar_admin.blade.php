    ...
    <div class="top-bar" style="background:#ffffff">
      <div class="container" style="height: 50px">
        <div class="row d-flex align-items-center">
          <div class="col-md-12">
            <img src="{{url('img/logo.png')}}" alt="Universal logo" class="d-none d-md-inline-block"><img src="{{url('img/logo-small.png')}} " alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
